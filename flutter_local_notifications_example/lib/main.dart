    ...
    socket
      ...
      ..on('time', (data) {
        ...
        if (_message.isNotEmpty) {
          showNotification('channelID', 'channelName', 'channelDecription',
              Importance.high, Priority.high, 'tiltle', _message, 'payload');
        }
      })
...
//
  ...
  Future<void> toSocketPage() async {
    await Navigator.of(context).push(MaterialPageRoute<void>(
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ElevatedButton(
                      onPressed: toSocketPage, child: Text(_message)),
                  const Divider(),
                  const Padding(
  ...
  Future<void> showNotification(
    ...
    AndroidNotificationDetails androidNotificationDetails =
        AndroidNotificationDetails(channelID, channelName,
            ...
            channelDescription: channelDecription,
            importance: importance,
            priority: priority,
            ticker: 'ticker');
    ...
    await flutterLocalNotificationsPlugin
        .show(id++, tiltle, body, notificationDetails, payload: payload);
  }
